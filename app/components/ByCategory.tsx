        ...
        <div id="category-container" className="flex flex-col w-full pb-8">
            ...
            <div className="flex w-full justify-center">
                <div className="grid gap-8 grid-flow-col grid-rows-2 pb-10">
                        <Link href={`${window.location.origin}/viewProducts?category=beauty&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=furniture&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=home-decoration&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=kitchen-accessories&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=mens-shirts&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=groceries&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=womens-shoes&sort=asc_name`} className="flex flex-col justify-center items-center">
                        ...
                        <Link href={`${window.location.origin}/viewProducts?category=fragrances&sort=asc_name`} className="flex flex-col justify-center items-center">
